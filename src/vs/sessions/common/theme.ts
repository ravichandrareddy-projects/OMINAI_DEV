...
export const ominiModeActiveBackground = registerColor(
	'ominiMode.activeBackground', agentsPanelBackground,
	localize('ominiMode.activeBackground', 'Background color of the active OMINI mode indicator in the title bar.')
);

export const ominiModeStatusCooking = registerColor(
	'ominiMode.statusCooking', foreground,
	localize('ominiMode.statusCooking', 'Color of the cooking/status text in the OMINI progress indicator.')
);

export const ominiModeProviderBadge = registerColor(
	'ominiMode.providerBadge', ACTIVITY_BAR_BADGE_BACKGROUND,
	localize('ominiMode.providerBadge', 'Background color of the AI provider badge in the OMINI orchestrator view.')
);
