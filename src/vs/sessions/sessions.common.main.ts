...
import { IOMINIKeychainService, OMINIKeychainService } from './contrib/omini/common/ominiApiKeyConfig.js';
...
registerSingleton(IOMINIKeychainService, OMINIKeychainService, InstantiationType.Delayed);
...
import './contrib/omini/browser/ominiModeSwitcher.contribution.js';
import './contrib/omini/browser/ominiStatusIndicator.contribution.js';
import './contrib/omini/browser/ominiApiKeySettings.contribution.js';
import './contrib/omini/browser/ominiView.contribution.js';
