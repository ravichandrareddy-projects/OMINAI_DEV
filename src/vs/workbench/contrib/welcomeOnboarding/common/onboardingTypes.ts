...
export const ONBOARDING_AI_PREFERENCE_OPTIONS: readonly IAiPreferenceOption[] = [
	{
		...
		label: localize('onboarding.aiPref.codeFirst', "Normal"),
	...
	},
	{
		...
		label: localize('onboarding.aiPref.balanced', "OMINAI MODE"),
	...
	},
	{
		...
		label: localize('onboarding.aiPref.agentForward', "Agentic mode"),
